...
(function(k,p){"function"!==typeof Object.defineProperty&&(Object.defineProperty=function(a,b,d){"value"in d&&(a[b]=d.value);"get"in d&&a.__defineGetter__(b,d.get);"set"in d&&a.__defineSetter__(b,d.set);return a});"function"!==typeof Object.defineProperties&&(Object.defineProperties=function(a,b){for(var d in b)b.hasOwnProperty(d)&&Object.defineProperty(a,d,b[d]);return a});"function"!==typeof Object.create&&(Object.create=function(a,b){function d(){}d.prototype=a;a=new d;null!=b&&Object.defineProperties(a,
...
a=a.filter(function(a){return[a].join()}));(function f(d,c){var e=[],h;for(h in d)if(d.hasOwnProperty(h))if("function"===typeof d[h])k[h]=d[h];else if("object"===typeof d[h]&&null!==d[h]&&Object.getPrototypeOf(d[h])===Object.prototype)if(null==a)e.push(h);else{var l=a.indexOf(c+h);-1!==l&&(e.push(h),a.splice(l,1))}l=0;for(h=e.length;l<h;l++)f(d[e[l]],c+e[l]+".")})(c,"");c.Class.getInheritanceTree(k.Game).length<=c.Class.getInheritanceTree(k.Core).length&&(k.Game=k.Core);if(null!=a&&a.length)throw Error("Cannot load module: "+
...
Array.prototype.push.apply(this._assets,a);return this},load:function(b,d,e,f){if("string"===typeof d){var g=d;e=e||function(){};f=f||function(){}}else{g=b;var h=e;e=d||function(){};f=h||function(){}}var l=c.Core.findExt(b);return c.Deferred.next(function(){var d=new c.Deferred,h=function(a){d.call(a);e.call(this,a)},k=function(a){d.fail(a);f.call(this,a)};if(c.Core._loadFuncs[l])c.Core.instance.assets[g]=c.Core._loadFuncs[l](b,l,h,k);else{var n=new XMLHttpRequest;n.open("GET",b,!0);n.onreadystatechange=
function(){if(4===n.readyState){if(200!==n.status&&0!==n.status){var d=new c.Event("error");d.message=n.status+": Cannot load an asset: "+b;k.call(c.Core.instance,d)}d=n.getResponseHeader("Content-Type")||"";d.match(/^image/)?a.assets[g]=c.Surface.load(b,h,k):d.match(/^audio/)?a.assets[g]=c.Sound.load(b,d,h,k):(a.assets[g]=n.responseText,h.call(c.Core.instance,new c.Event("load")))}};n.send(null)}return d})},start:function(b){var d=function(){this.frame=0;this.removeEventListener("load",d)};this.addEventListener("load",
d);this.currentTime=k.getTime();this.ready=this.running=!0;if(!this._activated&&(this._activated=!0,"mobilesafari"===c.ENV.BROWSER&&c.ENV.USE_WEBAUDIO&&c.ENV.USE_TOUCH_TO_START_SCENE)){var e=new c.Deferred,f=this._createTouchToStartScene();f.addEventListener(c.Event.TOUCH_START,function l(){this.removeEventListener(c.Event.TOUCH_START,l);var b=new c.WebAudioSound;b.buffer=c.WebAudioSound.audioContext.createBuffer(1,1,48E3);b.play();a.removeScene(f);a.start(e)},!1);a.pushScene(f);return e}this._requestNextFrame(0);
...
b){this.x+=a;this.y+=b},x:{get:function(){return this._x},set:function(a){this._x!==a&&(this._x=a,this._dirty=!0)}},y:{get:function(){return this._y},set:function(a){this._y!==a&&(this._y=a,this._dirty=!0)}},_updateCoordinate:function(){for(var a=this,b=[a],d=a.parentNode;d&&a._dirty;)b.unshift(d),a=a.parentNode,d=a.parentNode;d=c.Matrix.instance;var e=d.stack,f=[];e.push(b[0]._matrix);for(var g=1,h=b.length;g<h;g++){a=b[g];var l=[];d.makeTransformMatrix(a,f);d.multiply(e[e.length-1],f,l);a._matrix=
l;e.push(l);var k="number"===typeof a._originX?a._originX:a._width/2||0;var q="number"===typeof a._originY?a._originY:a._height/2||0;var t=[k,q];d.multiplyVec(l,t,t);a._offsetX=t[0]-k;a._offsetY=t[1]-q;a._dirty=!1}d.reset()},remove:function(){this.parentNode&&this.parentNode.removeChild(this);if(this.childNodes)for(var a=this.childNodes.slice(),b=a.length-1;0<=b;b--)a[b].remove();this.clearEventListener()}});var m=function(a,b){for(var d=[],c,f=0,g=a.collection.length;f<g;f++)c=a.collection[f],b._intersectOne(c)&&
d.push(c);return d},z=function(a,b){for(var d=[],c,f=0,g=a.collection.length;f<g;f++)c=a.collection[f],b._intersectStrictOne(c)&&d.push(c);return d},T=function(a){if(a instanceof c.Entity)return m(this,a);if("function"===typeof a&&a.collection){for(var b=[],d,e,f=0,g=this.collection.length;f<g;f++){d=this.collection[f];for(var h=0,l=a.collection.length;h<l;h++)e=a.collection[h],d._intersectOne(e)&&b.push([d,e])}return b}return!1},U=function(a){if(a instanceof c.Entity)return z(this,a);if("function"===
typeof a&&a.collection){for(var b=[],d,e,f=0,g=this.collection.length;f<g;f++){d=this.collection[f];for(var h=0,l=a.collection.length;h<l;h++)e=a.collection[h],d._intersectStrictOne(e)&&b.push([d,e])}return b}return!1},V=c.Node.prototype.clearEventListener;c.Entity=c.Class.create(c.Node,{initialize:function(){var a=c.Core.instance;c.Node.call(this);this._rotation=0;this._scaleY=this._scaleX=1;this._touchEnabled=!0;this._clipping=!1;this._originY=this._originX=null;this._height=this._width=0;this._backgroundColor=
...
set:function(a){this._opacity=parseFloat(a)}},visible:{get:function(){return this._visible},set:function(a){this._visible=a}},touchEnabled:{get:function(){return this._touchEnabled},set:function(a){this._touchEnabled=a;this._style.pointerEvents=a?"all":"none"}},intersect:function(a){return a instanceof c.Entity?this._intersectOne(a):"function"===typeof a&&a.collection?m(a,this):!1},_intersectOne:function(a){this._dirty&&this._updateCoordinate();a._dirty&&a._updateCoordinate();return this._offsetX<
a._offsetX+a.width&&a._offsetX<this._offsetX+this.width&&this._offsetY<a._offsetY+a.height&&a._offsetY<this._offsetY+this.height},intersectStrict:function(a){return a instanceof c.Entity?this._intersectStrictOne(a):"function"===typeof a&&a.collection?z(a,this):!1},_intersectStrictOne:function(a){this._dirty&&this._updateCoordinate();a._dirty&&a._updateCoordinate();var b=this.getOrientedBoundingRect();a=a.getOrientedBoundingRect();var d=b.leftTop,c=b.rightTop,f=b.leftBottom,g=b.rightBottom,h=a.leftTop,
l=a.rightTop,k=a.leftBottom,q=a.rightBottom,t=d[0],n=d[1],m=c[0],p=c[1],C=f[0],y=f[1],w=g[0],D=g[1],E=h[0],u=h[1],G=l[0],H=l[1],I=k[0],J=k[1],K=q[0],L=q[1],r=[m-t,p-n],v=[w-m,D-p],A=[C-w,y-D],B=[t-C,n-y];a=[G-E,H-u];b=[K-G,L-H];var F=[I-K,J-L],x=[E-I,u-J],M=t+m+C+w>>2,N=n+p+y+D>>2,O=E+G+I+K>>2,P=u+H+J+L>>2;if(0<r[0]*(P-n)-r[1]*(O-t)&&0<v[0]*(P-p)-v[1]*(O-m)&&0<A[0]*(P-D)-A[1]*(O-w)&&0<B[0]*(P-y)-B[1]*(O-C)||0<a[0]*(N-u)-a[1]*(M-E)&&0<b[0]*(N-H)-b[1]*(M-G)&&0<F[0]*(N-L)-F[1]*(M-K)&&0<x[0]*(N-J)-x[1]*
(M-I))return!0;d=[d,c,g,f];c=[h,l,q,k];f=[r,v,A,B];b=[a,b,F,x];for(a=0;4>a;a++)for(x=d[a],F=x[0],x=x[1],l=f[a],h=l[0],k=l[1],l=0;4>l;l++)if(r=c[l],B=r[0],g=r[1],v=b[l],r=v[0],v=v[1],A=h*v-k*r,0!==A&&(B-=F,q=g-x,g=(B*k-q*h)/A,r=(B*v-q*r)/A,0<g&&1>g&&0<r&&1>r))return!0;return!1},within:function(a,b){this._dirty&&this._updateCoordinate();a._dirty&&a._updateCoordinate();null==b&&(b=(this.width+this.height+a.width+a.height)/4);var d;return(d=this._offsetX-a._offsetX+(this.width-a.width)/2)*d+(d=this._offsetY-
...
g=d/g;for(var h=0,l=this._splitText.length;h<l;h++){var k=this._splitText[h];var q=k.text;for(c=0;q.length>c+g||a.measureText(q.slice(c,c+g)).width>d;){var m="";var n=g;for(f=0;0<n;)f=a.measureText(m).width<d?f+n:f-n,m=q.slice(c,c+f),n=n/2|0;a.fillText(m,0,b);b+=k.height-1;c+=f}m=q.slice(c,c+q.length);q="right"===this.textAlign?d-a.measureText(m).width:"center"===this.textAlign?(d-a.measureText(m).width)/2:0;0<this.borderWidth&&(a.lineWidth=this.borderWidth,a.strokeStyle=this.borderColor,a.strokeText(m,
q,b));a.fillText(m,q,b);b+=k.height-1}}},domRender:function(a){a.innerHTML!==this._text&&(a.innerHTML=this._text)},detectRender:function(a){a.fillRect(this._boundOffset,0,this._boundWidth,this._boundHeight)},updateBoundArea:function(){var a=this.getMetrics();this._boundWidth=a.width;this._boundHeight=a.height;this._boundOffset="right"===this.textAlign?this.width-this._boundWidth:"center"===this.textAlign?(this.width-this._boundWidth)/2:0},getMetrics:function(a){var b={};if(document.body){var d=document.createElement("div");
...
function(){this._dirty&&(this._previousOffsetX=this._previousOffsetY=null)})},loadData:function(a){this._data=Array.prototype.slice.apply(arguments);this._dirty=!0;this._tight=!1;for(var b=0,d=this._data.length;b<d;b++){var c=0;a=this._data[b];for(var f=0,g=a.length;f<g;f++)for(var h=0,l=a[f].length;h<l;h++)0<=a[f][h]&&c++;if(.2<c/(a.length*a[0].length)){this._tight=!0;break}}},checkTile:function(a,b){if(0>a||this.width<=a||0>b||this.height<=b)return!1;var d=this._image.width,c=this._image.height;
return this._data[0][b/(this._tileHeight||c)|0][a/(this._tileWidth||d)|0]},hitTest:function(a,b){if(0>a||this.width<=a||0>b||this.height<=b)return!1;var d=this._image.width,c=this._image.height,f=this._tileWidth||d,g=this._tileHeight||c;a=a/f|0;b=b/g|0;if(null!=this.collisionData)return this.collisionData[b]&&!!this.collisionData[b][a];for(var h=0,l=this._data.length;h<l;h++){var k=this._data[h],m;if(null!=k[b]&&null!=(m=k[b][a])&&0<=m&&m<(d/f|0)*(c/g|0))return!0}return!1},image:{get:function(){return this._image},
set:function(a){var b=c.Core.instance;this._image=a;if(c.ENV.RETINA_DISPLAY&&2===b.scale){b=new c.Surface(2*a.width,2*a.height);for(var d=this._tileWidth||a.width,e=this._tileHeight||a.height,f=a.width/d|0,g=a.height/e|0,h=0;h<g;h++)for(var l=0;l<f;l++)b.draw(a,l*d,h*e,d,e,l*d*2,h*e*2,2*d,2*e);this._doubledImage=b}this._dirty=!0}},tileWidth:{get:function(){return this._tileWidth},set:function(a){this._tileWidth!==a&&(this._tileWidth=a,this._dirty=!0)}},tileHeight:{get:function(){return this._tileHeight},
set:function(a){this._tileHeight!==a&&(this._tileHeight=a,this._dirty=!0)}},width:{get:function(){return this._tileWidth*this._data[0][0].length}},height:{get:function(){return this._tileHeight*this._data[0].length}},redraw:function(a,b,d,c){if(null!=this._image){if(this._doubledImage){var e=this._doubledImage;var g=2*this._tileWidth;var h=2*this._tileHeight;var l=2*-this._offsetX;var k=2*-this._offsetY;a*=2;b*=2;d*=2;c*=2}else e=this._image,g=this._tileWidth,h=this._tileHeight,l=-this._offsetX,k=
-this._offsetY;var m=e.width/g|0,p=e.height/h|0,n=Math.max((a+l)/g|0,0),R=Math.max((b+k)/h|0,0),z=Math.ceil((a+l+d)/g),C=Math.ceil((b+k+c)/h);e=e._element;var y=this._context;y.clearRect(a,b,d,c);d=0;for(c=this._data.length;d<c;d++){var w=this._data[d],D=Math.min(z,w[0].length),E=Math.min(C,w.length);for(b=R;b<E;b++)for(a=n;a<D;a++){var u=w[b][a];0<=u&&u<m*p&&y.drawImage(e,u%m*g,(u/m|0)*h,g,h,a*g-l,b*h-k,g,h)}}}},updateBuffer:function(){if(this._visible===p||this._visible){var a=c.Core.instance;if(this._dirty||
null==this._previousOffsetX)this.redraw(0,0,a.width,a.height);else if(this._offsetX!==this._previousOffsetX||this._offsetY!==this._previousOffsetY)if(this._tight){var b=-this._offsetX,d=-this._offsetY,e=-this._previousOffsetX,f=-this._previousOffsetY,g=b-e+a.width,h=e-b+a.width,l=d-f+a.height,k=f-d+a.height;if(g>this._tileWidth&&h>this._tileWidth&&l>this._tileHeight&&k>this._tileHeight){if(g<h){var m=0;b=e-b;h=g}else m=b-e,b=0;l<k?(g=0,d=f-d):(g=d-f,d=0,l=k);null==a._buffer&&(a._buffer=document.createElement("canvas"),
a._buffer.width=this._context.canvas.width,a._buffer.height=this._context.canvas.height);k=a._buffer.getContext("2d");this._doubledImage?(k.clearRect(0,0,2*h,2*l),k.drawImage(this._context.canvas,2*m,2*g,2*h,2*l,0,0,2*h,2*l),k=this._context,k.clearRect(2*b,2*d,2*h,2*l),k.drawImage(a._buffer,0,0,2*h,2*l,2*b,2*d,2*h,2*l)):(k.clearRect(0,0,h,l),k.drawImage(this._context.canvas,m,g,h,l,0,0,h,l),k=this._context,k.clearRect(b,d,h,l),k.drawImage(a._buffer,0,0,h,l,b,d,h,l));0===b?this.redraw(h,0,a.width-
h,a.height):this.redraw(0,0,a.width-h,a.height);0===d?this.redraw(0,l,a.width,a.height-l):this.redraw(0,0,a.width,a.height-l)}else this.redraw(0,0,a.width,a.height)}else this.redraw(0,0,a.width,a.height);this._previousOffsetX=this._offsetX;this._previousOffsetY=this._offsetY}},cvsRender:function(a){if(0!==this.width&&0!==this.height){var b=c.Core.instance;this.updateBuffer();a.save();a.setTransform(1,0,0,1,0,0);a.drawImage(this._context.canvas,0,0,b.width,b.height);a.restore()}},domRender:function(a){this._image&&
...
g=a.height||0,h="number"===typeof a._scaleX?a._scaleX:1,l="number"===typeof a._scaleY?a._scaleY:1,k=(a._rotation||0)*Math.PI/180,m=Math.cos(k);k=Math.sin(k);f="number"===typeof a._originX?a._originX:f/2;a="number"===typeof a._originY?a._originY:g/2;g=h*m;h*=k;k*=l;l*=m;b[0]=g;b[1]=h;b[2]=-k;b[3]=l;b[4]=-g*f+k*a+d+f;b[5]=-h*f-l*a+c+a},multiply:function(a,b,d){var c=a[0],f=a[2],g=a[4],h=a[1],k=a[3];a=a[5];var m=b[0],q=b[2],p=b[4],n=b[1],z=b[3];b=b[5];d[0]=c*m+f*n;d[1]=h*m+k*n;d[2]=c*q+f*z;d[3]=h*q+
k*z;d[4]=c*p+f*b+g;d[5]=h*p+k*b+a},multiplyVec:function(a,b,d){var c=b[0];b=b[1];var f=a[1],g=a[3],h=a[5];d[0]=a[0]*c+a[2]*b+a[4];d[1]=f*c+g*b+h}});c.Matrix.instance=new c.Matrix;c.DetectColorManager=c.Class.create({initialize:function(a,b){this.reference=[];this.colorResolution=a||16;this.max=b||1;this.capacity=Math.pow(this.colorResolution,3);a=1;for(b=this.capacity;a<b;a++)this.reference[a]=null},attachDetectColor:function(a){var b=this.reference.indexOf(null);-1===b&&(b=1);this.reference[b]=a;
...
d=this._layerPriority.length-1;0<=d&&!(b=this._layers[this._layerPriority[d]],b=b._determineEventTarget(a));d--);b||(b=this);return b},_onchildadded:function(a){var b=a.node;a=a.next;if(b._element){var d="Dom";var c=1}else d="Canvas",c=0;this._layers[d]||this.addLayer(d,c);b._layer=this._layers[d];this._layers[d].insertBefore(b,a);b.parentNode=this},_onchildremoved:function(a){a=a.node;a._layer.removeChild(a);a._layer=null},_onenter:function(){for(var a in this._layers)this._layers[a]._startRendering();
...
c.Easing.BOUNCE_EASEIN(2*a,0,d,e)+b:.5*c.Easing.BOUNCE_EASEOUT(2*a-e,0,d,e)+.5*d+b},BACK_EASEIN:function(a,b,c,e,f){f===p&&(f=1.70158);return c*(a/=e)*a*((f+1)*a-f)+b},BACK_EASEOUT:function(a,b,c,e,f){f===p&&(f=1.70158);return c*((a=a/e-1)*a*((f+1)*a+f)+1)+b},BACK_EASEINOUT:function(a,b,c,e,f){f===p&&(f=1.70158);return 1>(a/=e/2)?c/2*a*a*(((f*=1.525)+1)*a-f)+b:c/2*((a-=2)*a*(((f*=1.525)+1)*a+f)+2)+b},EXPO_EASEIN:function(a,b,c,e){return 0===a?b:c*Math.pow(2,10*(a/e-1))+b},EXPO_EASEOUT:function(a,
...
enchant.ui.Button2=enchant.Class.create(enchant.Entity,{initialize:function(k,p,c){enchant.Entity.call(this);enchant.CanvasLayer&&(this._element="div");this.width=p||null;this.height=c||null;this._text=k;this.pressed=!1;var m=this._style;k=Math.min(c/2,(p-20)/(k.length+2));m.width=p+"px";m.height=c+"px";m.display="table-cell";m["font-family"]=UI_FONT_FAM;m["font-size"]=k+"px";m["font-weight"]="bold";m.cursor="pointer";m["text-align"]="center";m["vertical-align"]="middle";m["line-height"]=c+"px";m["text-decoration"]=
"none";m.background="#ffbe6b";m.color="#FFF";m["text-shadow"]="-1px -1px 0 rgba(0,0,0,0.2)";m["border-radius"]="10px";m["box-shadow"]="inset 0 3px 0 rgba(255,255,255,0.2), inset 0 -3px 0 rgba(0, 0, 0, 0.05)";m.border="solid 2px #d27d00";m["box-sizing"]="border-box";this.addEventListener("touchstart",function(){m["box-shadow"]="0 0 2px rgba(0, 0, 0, 0.30)";this.pressed=!0});this.addEventListener("touchend",function(){m["box-shadow"]="inset 0 3px 0 rgba(255,255,255,0.2), inset 0 -3px 0 rgba(0, 0, 0, 0.05)";
this.pressed=!1})},cvsRender:function(){},domRender:function(){this._domManager.element.innerHTML=this._text}});
enchant.ui.ButtonVanishBugFix=enchant.Class.create(enchant.Entity,{initialize:function(k){enchant.Entity.call(this);enchant.CanvasLayer&&(this._element="div");this.height=this.width=null;this._text="";this.pressed=!1;var p=this._style;p.width="0px";p.height="0px";p.border="solid 1px rgba(0,0,0,0)";this.moveTo(0,0);k.addChild(this)},cvsRender:function(){},domRender:function(){this._domManager.element.innerHTML=this._text}});
